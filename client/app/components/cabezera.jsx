...
import { Sarabun, Noto_Sans_Javanese, Roboto } from "next/font/google"
...
*
*
* Este es un test, probando una nueva barra de navegación
*
*
*
*
                ...
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="hidden md:block">
                        <nav aria-label="Global" className={roboto.className}>
                            <ul className="flex items-center gap-6 text-xl mt-1">
                                <li>
                                    <a id="hea" href="/about"> About </a>
                                </li>

                                <li>
                                    <a id="hea" href="#"> Cursos </a>
                                </li>

                                <li>
                                    <a id="hea" href="#"> Precios </a>
                                </li>

                                <li>
                                    <a id="hea" href="#"> Publicar </a>
                                </li>

                                <li>
                                    <a id="hea" href="#"> Mi cuenta </a>
                                </li>

                                <li>
                                    <a id="hea" href="#"> Contacto </a>
                                </li>
                            </ul>
                        </nav>
                    </div>
